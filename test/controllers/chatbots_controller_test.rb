...
class ChatbotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatbot" do
    assert_difference('Chatbot.count') do
      post chatbots_url, params: { chatbot: { message: @chatbot.message, name: @chatbot.name } }
    end
  ...
  test "should update chatbot" do
    patch chatbot_url(@chatbot), params: { chatbot: { message: @chatbot.message, name: @chatbot.name } }
